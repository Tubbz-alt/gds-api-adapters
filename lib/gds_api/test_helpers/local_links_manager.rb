...
module GdsApi
  module TestHelpers
    module LocalLinksManager
      ...
      def stub_local_links_manager_has_a_link(authority_slug:, lgsl:, lgil:, url:, country_name:)
        response = {
          "local_authority" => {
      ...
      def stub_local_links_manager_has_no_link(authority_slug:, lgsl:, lgil:, country_name:)
        response = {
          "local_authority" => {
            "name" => authority_slug.capitalize,
            "snac" => "00AG",
      ...
      def stub_local_links_manager_has_no_link_and_no_homepage_url(authority_slug:, lgsl:, lgil:, country_name:)
        response = {
          "local_authority" => {
            "name" => authority_slug.capitalize,
            "snac" => "00AG",
